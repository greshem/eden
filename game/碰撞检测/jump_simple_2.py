...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
		...
		#f=font.render(unicode("ÄãºÃ", "utf8"),True,(0,0,0),(255,255,255))
        f=font.render("linux",True,(0,0,255),(255,255,0))
...
class Platform(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, size):
        ...
        words=['love', 'linux', 'test', 'find', "ls", "image", "rect", "choice", "me", "you"]
        font = pygame.font.Font("font.ttf",20) 
        word = random.choice(words)
        f=font.render(word, True,(0,0,255),(255,255,0))
        self.image.blit(f, (0,0))
